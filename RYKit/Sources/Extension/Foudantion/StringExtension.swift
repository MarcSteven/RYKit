...
extension String {
    ...
    /// is valid email
    /// - Returns: if the email is ok, return true, or false 
...
extension String {
   /// extract substrings from a string that match a regex pattern.
    ...
    /// - Returns: if the pattern matched, return true, or false
...
extension StringProtocol {
    ...
    /// index from
    /// - Parameter from: from a index
    /// - Returns: return the index
...
public extension String {
    ...
    /// is mobile number
    /// - Returns: if it's mobile, return true, or false
...
public extension String {
    ...
    /// - Returns: return a new string without prefix
    ...
    /// - Returns: return a new string without suffix
...
extension String {
    ...
    /// substring
    /// - Parameter from: from int
    /// - Returns: return the string from int
    ...
    /// substring
    /// - Parameter to: to int
    /// - Returns: return the value of int
...
extension String {
    ...
    /// url encoded string
    /// - Parameter encodeAll: is encode all
    /// - Returns: string
...
extension String {
    ...
    /// match string range
    /// - Parameter matchStr: matched string
    /// - Returns: range of matching
...
public extension String {
    ...
    /// apply pattern on numbers
    /// - Parameters:
    ///   - pattern: pattern
    ///   - replacmentCharacter: replacement character
    /// - Returns: return string
...
//MARK:- 检测身份证号
public extension String {
    static func checkIDNumber(_ number:String) ->Bool {
...
public extension String {
    ...
    static func getBankName(_ cardId:String?) ->String? {
        ...
        let cardBin_8 = (cardId as NSString?)?.substring(with: NSRange(location: 0, length: 8))
        for i in 0..<bankBin.count {
