//
//  NSAttributedString+CountLength.swift
//  RYKit
//
...
extension String {
    /// 判断是否包含某个子字符串
    func isIncludeString(string: String) -> Bool {
    ...
    /// 将文字中的换行符替换为空格
    func trimLineBreakCharacter() -> String {
    ...
    static func stringByConcat(_ argvs: Any...) -> String {
        var result = ""
        for argv in argvs {
     ...
     */
    static func timeStringWithMinsAndSecs(from seconds: Double) -> String {
     ...
     *  @return 裁剪完的字符
     */
    func substringAvoidBreakingUpCharacterSequencesFromIndex(index: Int, lessValue: Bool, countingNonASCIICharacterAsTwoindex: Bool) -> String {
     ...
     */
    func substringAvoidBreakingUpCharacterSequencesFromIndex(index: Int) -> String {
        return substringAvoidBreakingUpCharacterSequencesFromIndex(index: index, lessValue: true, countingNonASCIICharacterAsTwoindex: false)
    }
     ...
     *  @param countingNonASCIICharacterAsTwo 是否按照 英文 1 个字符长度、中文 2 个字符长度的方式来裁剪
     */
    func substringAvoidBreakingUpCharacterSequencesToIndex(index: Int, lessValue: Bool, countingNonASCIICharacterAsTwo: Bool) -> String {
     ...
     */
    func substringAvoidBreakingUpCharacterSequencesToIndex(index: Int) -> String {
        return substringAvoidBreakingUpCharacterSequencesToIndex(index: index, lessValue: true, countingNonASCIICharacterAsTwo: false)
    }
     ...
     *  @return 裁剪完的字符
     */
    func substringAvoidBreakingUpCharacterSequencesWithRange(range: Range<String.Index>, lessValue: Bool, countingNonASCIICharacterAsTwo: Bool) -> String {
     ...
     */
    func substringAvoidBreakingUpCharacterSequencesWithRange(range: Range<String.Index>) -> String {
        return substringAvoidBreakingUpCharacterSequencesWithRange(range: range, lessValue: true, countingNonASCIICharacterAsTwo: false)
    }
     ...
     *  @param index 要删除的位置
     */
    func stringByRemoveCharacter(at index: Int) -> String {
     ...
     */
    func stringByRemoveLastCharacter() -> String {
        return stringByRemoveCharacter(at: length - 1)
    }
