...
//        ringLayer.strokeColor = ringColor?.cgColor
    ...
    /// handle long press
    /// - Parameter recognizer: long press gesture
    ...
    /// is tool tip visiable
    /// - Returns: if it's visiable, it returns true, or false
   private func isTooltipVisiable() -> Bool {
...
private extension NSAttributedString {
    ...
    /// size to fit
    /// - Parameter maxSize: max size
    /// - Returns: return cgsize
...
private class ToolTip : CAShapeLayer, CAAnimationDelegate {
    ...
    /// - Returns: return spring animation
